...
var moonside = [
	...
	"Everyone always wants a magical solution, yet they refuse to believe in magic.",
	"A dream is not reality, but who's to say which is which?",
	"No matter where you go, everyone's always connected.",
	"Welcome home.",
	"May you find your worth in the waking world.",
	"Let this dream foretell a pleasant awakening.",
	"aaaaaAAAAA????",
	"Even in the dream, you must still remember to hydrate.",
	"Remember to breathe.",
	"¤ The virtual plaza welcomes you ¥ &nbsp;",
	"I'm constantaly afriad of the future, and terrified of the past.",
	"You create for yourself, the audience is just eavesdropping.",
